...
def test(opt):
    ...
    checkpoint_dir = f"saved_models/{opt['dataset_name']}"
    ...
    dataloader = DataLoader(
        ImageDataset(data_path, transforms_=transforms_, mode='test'),
    ...
    ###### Testing ######
    base_dir = f'{opt.get("output_dir", "output")}/{opt["dataset_name"]}'
